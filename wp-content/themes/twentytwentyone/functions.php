...
$labels = array(
'name' => _x('sword', 'plural'),
'singular_name' => _x('sword', 'singular'),
'menu_name' => _x('sword', 'admin menu'),
'name_admin_bar' => _x('sword', 'admin bar'),
'add_new' => _x('Add Sword', 'add Sword'),
'add_new_item' => __('Add Sword'),
'new_item' => __('New sword'),
'edit_item' => __('Edit sword'),
'view_item' => __('View sword'),
'all_items' => __('All sword'),
'search_items' => __('Search sword'),
'not_found' => __('No sword found.'),
);

$args = array(
'supports' => $supports,
'labels' => $labels,
'description' => 'Holds our Sword and specific data',
'public' => true,
'taxonomies' => false,
'show_ui' => true,
'show_in_menu' => true,
...
register_post_type('swords', $args); // Register Post type
}
...
function accordion_custom_init() {

      register_post_type(
        'accordions', array(
          'labels' => array('name' => __( 'Accordions' ), 'singular_name' => __( 'Accordian' ) ),
          'public' => true,
          'has_archive' => true,
    ...
    add_action( 'init', 'accordion_custom_init' );
...
//additional custom post
  ...
  add_action( 'init', 'modal_custom_init' );


//additional custom post
function carousels_custom_init() {

       register_post_type(
        'carousels', array(
          'labels' => array('name' => __( 'Carousels' ), 'singular_name' => __( 'Carousel' ) ),
          'public' => true,
          'has_archive' => true,
          'supports' => array('title', 'editor', 'thumbnail')
        )
    ...
    add_action( 'init', 'carousels_custom_init' );