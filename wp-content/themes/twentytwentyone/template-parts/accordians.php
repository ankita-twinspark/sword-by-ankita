...
'add_new' => _x('Add Accordion', 'add Accordion'),
'add_new_item' => __('Add Accordion'),
...
'supports' => $supports,
'labels' => $labels,
'description' => 'Holds our Accordion and specific data',
'public' => true,
'taxonomies' => false,
'show_ui' => true,
'show_in_menu' => true,
...
register_post_type('Accordion', $args); // Register Post type
}
