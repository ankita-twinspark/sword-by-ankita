 ...
 */
function gp_scripts() {
	wp_enqueue_style( 'gp-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'gp-style', 'rtl', 'replace' );

	wp_enqueue_script( 'gp-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
